...
export function readFiltersFromUI(bar: HTMLElement): FilterState {
  // Activity types
...
export function restoreFiltersToUI(bar: HTMLElement, filters: FilterState): void {
...
export interface FilterBarDeps {
  onApply: (bar: HTMLElement) => void;
  onApplyReload: (bar: HTMLElement) => void;
  onClear: (bar: HTMLElement) => void;
  onHelp: () => void;
}

export function wireUpInteractions(bar: HTMLElement, deps: FilterBarDeps): void {
